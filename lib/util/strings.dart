...
const String msg2="All the poll staffs have reported to their polling stations according to the report received from ARO(Zones).";
const String msg3="Poll has commenced at all the polling stations at the specified time at 7.00 a.m. according to reports received from ARO(Zones).";
